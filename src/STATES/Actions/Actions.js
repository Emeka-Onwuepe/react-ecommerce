...
export const getstore = () => {
    return axios.get('https://castechapps.herokuapp.com/api/products').then(res => {
...
export const getCategory = (data, type) => {
    return axios.post('https://castechapps.herokuapp.com/api/products', data).then(res => {
...
export const RegisterUser = (data, config) => {
    return axios.post('https://castechapps.herokuapp.com/api/register', data, config).then(res => {
        return {
            type: REGISTERUSER,
            data: res.data,
...
export const processOrder = (data, config) => {
    return axios.post('https://castechapps.herokuapp.com/api/orderview', data, config).then(res => {
        return {
            type: PROCESS_ORDER,
            data: res.data,
...
export const LoginUser = (data, config) => {
    return axios.post('https://castechapps.herokuapp.com/api/login', data, config).then(res => {
...
export const LogOut = (data, config) => {
    return axios.post('https://castechapps.herokuapp.com/api/logout', null, config).then(res => {
...
export const sendMail = (data, config) => {
    return axios.post('https://castechapps.herokuapp.com/api/ContactUS', data, config).then(res => {
